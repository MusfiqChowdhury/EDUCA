...
<head>
  ...
  <style>
    * {
    ...
    .register-link {
  margin: 20px auto; /* Adjust margin to center vertically and horizontally */
  color: white;
...
<body>
  <div class="container">
    ...
    <form id="loginForm" class="login-form" action="#" method="POST">
      ...
      <a href="Home_Student.html" class="btn">Login</a>

      <div id="errorMsg" class="error-msg"></div>
      <p class="create-account">No Account? Please Create</p> <!-- Added text -->
      <a href="RegistrationStudent.html" class="register-link">Register</a> <!-- Added registration button -->
    </form>
  </div>
